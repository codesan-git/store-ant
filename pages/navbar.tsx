          ...
          {session ? (
            <div className="flex">
              ...
              <div className="dropdown dropdown-end" onClick={() => readNotif()}>
                <label tabIndex={0} className="relative btn btn-ghost m-1 text-lg">
                  <HiBell className="hidden h-5 w-5 sm:block" />
                  <div className="absolute indicator top-2 right-[0.5rem]">
                    {notif ? (

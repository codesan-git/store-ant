...
export default function Complain() {
  ...
  const {id: productInCartId} = router.query;
  ...
  const handleUpload = async () => {
    try {
        ...
        formData.append("productInCartId", productInCartId as string);
        formData.append("description", desc);
        await axios.post('http://localhost:3000/api/complain/create', formData).then(() => {router.back() });
    } catch (error: any) {
        //console.log(error);
    }
  }

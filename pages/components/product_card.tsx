...
const ProductCard = ( {product, onClick , onEdit, onDelete} : Props ) => {
    ...
    return (
      <div id="card" data-theme="garden" className='card glass w-30 h-64 lg:h-auto lg:w-auto hover:cursor-pointer' onClick={onCardClick}>  {/*Find a way to style cursor pointer if onClick is not null*/}
        {product.image? (
          <img 

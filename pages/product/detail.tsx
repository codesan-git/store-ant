  ...
  return (
    <div>
      ...
      <div className="sm:flex sm:flex-row">
        ...
        <div
          id="mobile-item-order-section"
          className="visible lg:invisible fixed bottom-0 left-0 bg-blue-gray-300 flex flex-row p-2 h-18 w-screen align-middle justify-center"
        >
          <section
            id="price-section"
          ...
          <section
            id="button-actions-section"
            className="w-1/2 space-x-2 flex flex-row justify-center"
          >

...
const Footer = () => {
  return (
    <>
      ...
      <div id="footer-mobile" className="lg:hidden">
        <hr style={{ border: "none", height: "1px", backgroundColor: "#bfc9d9" }} /> {/* garis lebih lebar */}
        <footer className="py-10">
          <div className="footer mx-auto">
            <div className="w-full grid grid-cols-2 px-2">
              <div className="col-span-1">
                <p className="footer-title">Store.ant</p>
              ...
              <div className="col-span-1">
                <p className="footer-title">Beli</p>
            ...
            <div className="w-full grid grid-cols-2 px-2">
              <div className="col-span-1">
                <p className="footer-title">Bantuan dan <br />Panduan</p>
                <p className="link link-hover">Terms of use</p>
                <p className="link link-hover">Privacy policy</p>
                <p className="link link-hover">Cookie policy</p>
              </div>
              <div className="col-span-1">
                <p className="footer-title">Jual</p>
                <p className="link link-hover">Terms of use</p>
                <p className="link link-hover">Privacy policy</p>
                <p className="link link-hover">Cookie policy</p>
              </div>
            ...
            <div className="w-full grid grid-cols-2 px-2">
              <div className="col-span-1">
                <p className="footer-title">Keamanan dan<br /> Privasi</p>
